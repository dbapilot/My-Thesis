...
\begin{itemize}
  ...
  \item To find the limitations of the approaches and to understand the scope for further research, which contributes towards building better query Performance. %\cite{CostEstimation}.
\end{itemize}
