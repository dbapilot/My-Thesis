...
\begin{lstlisting}[style=sqlstyle, caption={SQL query to Semantic check}]
SQL>SELECT *
FROM   nonexistent_table;SELECT                   *
FROM   nonexistent_table * error at line 1: ora-00942: TABLE
